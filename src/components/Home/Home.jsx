...
import home_image from "../../assets/logos/organic-products-hero.png";
import home_leaf from "../../assets/logos/logo-leaf-new.png"
...
export const Home = () => {
  ...
  return (
    ...
    <div className={styles.best_selling_products_titl}>Best Selling Products</div>
